            ...
            switch (mode)
            {
                case SubmitMode.ShortMessage:
                    ...
                    else
                    {
                        ...
                        // Mustafa Addition ////////////////////////////////
                        //var bparts = new List<byte[]>();
                        //foreach (string p in parts)
                        //{
                        //    bparts.Add(Encoding.BigEndianUnicode.GetBytes(p));
                        //}
                        ///////////////////////////////////////////////////
                        foreach (byte[] part in parts)
                        {
                            ...
                            // Mustafa Addistion ///////////////////////////////////////////////////////////
                            // origin : submitSm.ShortMessageBytes = new SmppBuffer(DefaultEncoding, part, (int)encodeDataCoding).Buffer;
                            // new : submitSm.ShortMessageBytes = new SmppBuffer(DefaultEncoding, part).Buffer;
                            ////////////////////////////////////////////////////////////////////////////////
                            submitSm.ShortMessageBytes = new SmppBuffer(DefaultEncoding, part).Buffer;
                            submitSmList.Add(submitSm);
