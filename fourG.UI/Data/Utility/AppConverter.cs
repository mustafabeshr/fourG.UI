...
namespace fourG.UI.Data.Utility
{
    public class AppConverter
    {
        ...
        public AppConverter(IAppDbContext db)
        {
            this._db = db;
        }
        public  LteOrder ToLteOrder(DataRow row)
        {
            ...
            order.PackageName = row["package_name"] == DBNull.Value ? string.Empty : Convert.ToString(row["package_name"]);
            order.AlterPackageId = row["alter_pkg_id"] == DBNull.Value ? string.Empty : Convert.ToString(row["alter_pkg_id"]);
            order.AlterPackageName = row["alter_package_name"] == DBNull.Value ? string.Empty : Convert.ToString(row["alter_package_name"]);
        ...
        public  LteOrderHistory ToLteOrderHistory(DataRow row)
        {
        ...
        public  MobileOffer ToMobileOffer(DataRow row)
        {
        ...
        public  OperationLog ToOperationLog(DataRow row)
        {
        ...
        public  Product ToProduct(DataRow row)
        {
        ...
        public  SubscriberExceedMaxValidity ToSubscriberExceedMaxValidity(DataRow row)
        {
        ...
        public  Subscriber ToSubscriber(DataRow row)
        {
        ...
        public  SubscriberPackage ToSubscriberPackage(DataRow row)
        {
            var result = new SubscriberPackage();
            result.Id = row["row_no"] == DBNull.Value ? 0 : Convert.ToInt32(row["row_no"]);
            result.MobileNo = row["mobile_no"] == DBNull.Value ? string.Empty : Convert.ToString(row["mobile_no"]);
            result.PackageId = row["bkg_id"] == DBNull.Value ? string.Empty : Convert.ToString(row["bkg_id"]);
            result.PackageName = row["package_name"] == DBNull.Value ? string.Empty : Convert.ToString(row["package_name"]);
            result.StartedOn = row["eff_date"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["eff_date"]);
            result.ExpiredOn = row["exp_date"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["exp_date"]);
            result.Status = row["status"] == DBNull.Value ? 0 : Convert.ToInt32(row["status"]);
            return result;
        }
        public  SubscriberPackageHistory ToSubscriberPackageHistory(DataRow row)
        {
        ...
        public  SMSReceiver ToSMSReceiver(DataRow row)
        {
        ...
        public  MessageSpool ToMessageSpool(DataRow row)
        {
        ...
        public  MessageSpoolHistory ToMessageSpoolHistory(DataRow row)
        {
        ...
        public  AppRole ToAppRole(DataRow row)
        {
        ...
        public async Task<AppOperator> ToAppOperator(DataRow row)
        {
            var result = new AppOperator();
            result.Id = row["op_id"] == DBNull.Value ? string.Empty : Convert.ToString(row["op_id"]);
            result.Name = row["op_name"] == DBNull.Value ? string.Empty : Convert.ToString(row["op_name"]);
            ...
            var userRole = row["op_role_id"] == DBNull.Value ? 0 : Convert.ToInt16(row["op_role_id"]);
            result.Role = await new AppRoleRepo(_db).GetSingleAsync(userRole);
            return result;
        }
    }
}
