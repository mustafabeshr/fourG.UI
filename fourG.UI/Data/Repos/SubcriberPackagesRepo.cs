...
namespace fourG.UI.Data.Repo
{
    public class SubcriberPackagesRepo
    {
        ...
        public async Task<List<SubscriberPackage>> GetListAsync(string mobileNo)
        {
            ...
            //}
            #endregion
            var sql = $"SELECT *, (Select [dbo].[fn_GetPackageName] ([bkg_id])) package_name FROM [dbo].[subscriber_bkgs] {where} ORDER BY row_no";
